...
<?php if(IG_J30): ?>
    <style type="text/css">
        #jform_menu_description_ifr{
            height: 200px !important;
        }

        #jform_gallery_description_ifr{
            height: 200px !important;
        }
...
<form action="<?php echo JRoute::_('index.php?option=com_igallery'); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
	<div class="width-60 fltlft form-horizontal" style="width: 60%;">
		<fieldset class="adminform">
            ...
            <?php if($this->isSite == false): ?>
                <?php echo $wrapperStart; ?>
                <?php echo $labelStart; ?><?php echo $this->form->getLabel('second_user'); ?><?php echo $labelEnd; ?>
                <?php echo $valueStart; ?><?php echo $this->form->getInput('second_user'); ?><?php echo $valueEnd; ?>
                <?php echo $wrapperEnd; ?>
            <?php endif; ?>

            <?php if($this->isSite == false): ?>
                <?php echo $wrapperStart; ?>
                <?php echo $labelStart; ?><?php echo $this->form->getLabel('third_user'); ?><?php echo $labelEnd; ?>
                <?php echo $valueStart; ?><?php echo $this->form->getInput('third_user'); ?><?php echo $valueEnd; ?>
                <?php echo $wrapperEnd; ?>
            <?php endif; ?>

            <?php if($this->isSite == false): ?>
                <?php echo $wrapperStart; ?>
                <?php echo $labelStart; ?><?php echo $this->form->getLabel('fourth_user'); ?><?php echo $labelEnd; ?>
                <?php echo $valueStart; ?><?php echo $this->form->getInput('fourth_user'); ?><?php echo $valueEnd; ?>
                <?php echo $wrapperEnd; ?>
            <?php endif; ?>
