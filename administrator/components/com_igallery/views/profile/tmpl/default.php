...
<form action="index.php?option=com_igallery" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
    ...
    <?php endif; ?>
		...
		<?php if(!IG_J30): ?><ul class="adminformlist"><?php endif; ?>
            ...
            <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('show_cat_author'); ?><?php echo $labelEnd; ?>
            <?php echo $valueStart; ?><?php echo $this->form->getInput('show_cat_author'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>
		...
		<?php if(!IG_J30): ?><ul class="adminformlist"><?php endif; ?>
            ...
            <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('mobile_hide_thumbs'); ?><?php echo $labelEnd; ?>
            <?php echo $valueStart; ?><?php echo $this->form->getInput('mobile_hide_thumbs'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>
		...
		<?php if(!IG_J30): ?><ul class="adminformlist"><?php endif; ?>
            ...
            <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('comments_position'); ?><?php echo $labelEnd; ?>
            <?php echo $valueStart; ?><?php echo $this->form->getInput('comments_position'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>
            ...
            <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('pinterest_button'); ?><?php echo $labelEnd; ?>
            <?php echo $valueStart; ?><?php echo $this->form->getInput('pinterest_button'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>
            ...
            <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('show_image_author'); ?><?php echo $labelEnd; ?>
            <?php echo $valueStart; ?><?php echo $this->form->getInput('show_image_author'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>

            <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('show_image_hits'); ?><?php echo $labelEnd; ?>
            <?php echo $valueStart; ?><?php echo $this->form->getInput('show_image_hits'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>
        ...
        <fieldset class="adminform">
            <legend><?php echo JText::_('LIGHTBOX_COLOR'); ?></legend>
            <?php if(!IG_J30): ?><ul class="adminformlist"><?php endif; ?>
                <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('lbox_back_color'); ?><?php echo $labelEnd; ?>
                <?php echo $valueStart; ?><?php echo $this->form->getInput('lbox_back_color'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>

                <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('lbox_back_custom'); ?><?php echo $labelEnd; ?>
                <?php echo $valueStart; ?><?php echo $this->form->getInput('lbox_back_custom'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>

                <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('lbox_back_opacity'); ?><?php echo $labelEnd; ?>
                <?php echo $valueStart; ?><?php echo $this->form->getInput('lbox_back_opacity'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>

                <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('lbox_front_color'); ?><?php echo $labelEnd; ?>
                <?php echo $valueStart; ?><?php echo $this->form->getInput('lbox_front_color'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>

                <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('lbox_front_custom'); ?><?php echo $labelEnd; ?>
                <?php echo $valueStart; ?><?php echo $this->form->getInput('lbox_front_custom'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>
		...
		<?php if(!IG_J30): ?><ul class="adminformlist"><?php endif; ?>
            ...
            <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('mobile_lbox_hide_thumbs'); ?><?php echo $labelEnd; ?>
            <?php echo $valueStart; ?><?php echo $this->form->getInput('mobile_lbox_hide_thumbs'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>
		...
		<?php if(!IG_J30): ?><ul class="adminformlist"><?php endif; ?>
            ...
            <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('lbox_comments_position'); ?><?php echo $labelEnd; ?>
            <?php echo $valueStart; ?><?php echo $this->form->getInput('lbox_comments_position'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>
            ...
            <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('lbox_pinterest_button'); ?><?php echo $labelEnd; ?>
            <?php echo $valueStart; ?><?php echo $this->form->getInput('lbox_pinterest_button'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>
            ...
            <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('lbox_show_image_author'); ?><?php echo $labelEnd; ?>
            <?php echo $valueStart; ?><?php echo $this->form->getInput('lbox_show_image_author'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>

            <?php echo $wrapperStart; ?><?php echo $labelStart; ?><?php echo $this->form->getLabel('lbox_show_image_hits'); ?><?php echo $labelEnd; ?>
            <?php echo $valueStart; ?><?php echo $this->form->getInput('lbox_show_image_hits'); ?><?php echo $valueEnd; ?><?php echo $wrapperEnd; ?>
